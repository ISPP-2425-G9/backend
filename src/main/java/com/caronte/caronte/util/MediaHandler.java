...
public class MediaHandler {
    ...
    public static String deleteFolderFromCloudinary(String folder) {
        Dotenv dotenv = Dotenv.load();
        Cloudinary cloudinary = new Cloudinary(dotenv.get("CLOUDINARY_IMAGES_URL"));
        
        try {
            Map<String, Object> result = cloudinary.api().deleteFolder(folder, null);
    
            return result.get("deleted").toString();
