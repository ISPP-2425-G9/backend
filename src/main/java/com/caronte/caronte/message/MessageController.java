...
public class MessageController {
    ...
    public ResponseEntity<?> getMessageById(@PathVariable Long messageId, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
    ...
    public ResponseEntity<?> getMessagesByCustomerId(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        Long customerId = userDetailsImpl.getId();
    ...
    @PostMapping
    public ResponseEntity<Map<String, ?>> createMessage(@Valid @RequestBody MessageRequestDto request, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        Long customerId = userDetailsImpl.getId();
    ...
    public ResponseEntity<?> updateMessage(@PathVariable Long messageId, @Valid @RequestBody MessageRequestDto request, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        Long customerId = userDetailsImpl.getId();
    ...
    public ResponseEntity<?> deleteMessage(@PathVariable Long messageId, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        Long customerId = userDetailsImpl.getId();
    ...
    public ResponseEntity<Map<String, ?>> isMessageOwner(@PathVariable Long messageId, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        Long customerId = userDetailsImpl.getId();
